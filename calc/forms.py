...
class ForecastForm(forms.Form):
    ...
    # frequency=forms.IntegerField(label='Frequency of intake')
    frequency=forms.ChoiceField(label="Frequency of intake", choices=[(0, "None"),(1, "1 x day"), (2,"2 x day"), (3,"3 x day")])
