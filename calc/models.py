...
class Supply(models.Model):
    ...
    supply_frequency=models.CharField(max_length=10, blank=True, null=True, choices=[("0", "None"),("1", "1 x day"), ("2","2 x day"), ("3","3 x day"), ("4", "4 x day"), ("5", "5 x day"), ("6", "6 x day")])
    ...
    unit=models.CharField(max_length=7, blank=True, choices=[('1', 'mg'), ('2', 'ml'), ('3', 'IU')] )
    packaging_presentation=models.CharField(max_length=10, blank=True, null=True, choices=[('1', 'tablet'), ('2', 'ampule'), ('3', 'vial'), ('4','bottle'), ('5', 'bag')])
